...
if (isset($_POST['update'])) {
    ...
    $qty = $_POST['quantity'];
    $price = $_POST['price'];
    $conn->query("UPDATE medicines SET name='$name', quantity=$qty, price=$price WHERE medicine_id=$id");
...
<form method="POST">
    ...
    <label>Price:</label>
    <input type="number" name="price" value="<?= $med['price'] ?>" required>

    <button type="submit" name="update">Update</button>
</form>
<a href="view_medicines.php" class="back">Back to List</a>
</div>
</body>
</html>
